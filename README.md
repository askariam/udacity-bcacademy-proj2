...
3. Run command __node simpleChain.js__ in the root directory to see chain validation with tempered blocks.
4. Run command __node simpleChain2.js__ in the root directory to see chain validation with NO tempered blocks (valid chain).
